...
const CardInfo = ({
    ...
    if (displayMode === 'dark') {
        cardContainerClass = "cardInfo--container"
    } else {
        cardContainerClass = "cardInfo--container-lm"
    }
    ...
    return (
        <div className={cardContainerClass}>
            <div className="
                ...
                w-150px
            ">
                <Image className="cardInfo--img" width={125} height={125} src={(image) ? image : NFT} alt="nft"/>
            </div>
